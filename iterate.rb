...
# 3. Below is a massive array of numbers. Iterate over the array and print out only the even ones.
...
# 4. Below is a list of 99 names. Iterate over the array and find the longest name in the whole list. Then print out "The longest name in the list is ______. It has ___ letters in it."
